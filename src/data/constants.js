export const Bio = {
  ...
  description:
    "As a Computer Science Master's graduate from Cleveland State University, I bring a wealth of experience in corporate settings, particularly in C# and .NET enterprise applications, Java and Android development. My academic journey has also equipped me with skills in full-stack applications, machine learning, AI, and big data analysis. With a thirst for learning and a dedication to excellence, I'm poised to contribute and excel in any challenge I undertake",
  github: "https://github.com/Atharvagurav08",
  resume:
    "https://drive.google.com/file/d/19EfWsr4zZaBdv_dMdk7Fd9GfEua7IAom/view?usp=sharing",
    ...
    skills: [
      {
        name: "C#",
        image:
          "https://static-00.iconduck.com/assets.00/c-sharp-icon-456x512-wlq0sh0z.png",
      },
      {
        name: "ASP.Net",
        image:
          "https://miro.medium.com/v2/resize:fit:1400/1*9S6fPkXpk0280FaaHMj8Lg.png",
      },
      {
        name: ".Net Core",
        image:
          "//upload.wikimedia.org/wikipedia/commons/thumb/e/ee/.NET_Core_Logo.svg/512px-.NET_Core_Logo.svg.png",
      },
    ],
  },
  {
...
export const experiences = [
  {
    id: 0,
    img: "https://upload.wikimedia.org/wikipedia/commons/8/87/Avery_Dennison_Logo.jpg",
    role: "Computer Science Intern",
    company: "Neurobit",
    date: "Sept 2022 - Sept 2023",
    desc: "Developed a robust traceability system for the food supply chain using C# and .NET, integrating international GS1 standards and advanced tracking APIs. Created a companion Android app for seamless mobile accessibility, ensuring cross-platform consistency.Enhanced physical tracking through RFID integration, contributing to improved transparency and monitoring in the food supply chain.",
    skills: [
      "C#",
      ".Net",
      "ASP.Net",
  ...
  {
    id: 1,
    img: "https://files.techmahindra.com/static/img/makerlab-newlago.jpg",
    role: "Software Developer Intern",
    company: "Tech Mahindra Maker's Lab",
    date: "Noc 2019 - May 2020",
    desc: `Contributed to developing "Stori-cool", an NLP-driven app mapping stories to animated assets via voice input. Optimized query execution with Neo4j, achieving 10x performance boost. Used C# to automate content creation in Unity, reducing population time by 12x. Integrated Cypher queries in Python, improving server response time by 30%. "Stori-cool" app used by 100+ users, receiving 85% satisfaction rating`,
    skills: [
      "Python",
      "C#",
      "Cypher",
...
export const education = [
  {
    id: 0,
    img: "https://upload.wikimedia.org/wikipedia/en/c/c9/Cleveland_State_University_logo.png",
    school: "Cleveland State University, Cleveland, Ohio",
  ...
  },
  {
    ...
    school: "Delhi Public School, Nagpur",
    date: "May 2014",
    grade: "8.4 CGPA%",
    desc: " ",
    degree: " ",
